...
<div class="row w-100" >
  ...
  <h4 class="display-5">BANK OF INDIA</h4>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/acc.jpg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/noti.png" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/contact.jpeg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
